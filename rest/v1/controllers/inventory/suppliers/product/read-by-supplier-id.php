...
if (isset($_SERVER['HTTP_AUTHORIZATION'])) {
    ...
    if (array_key_exists("start", $_GET) && array_key_exists("supplierid", $_GET)) {
        // get data
        ...
        $query = checkReadBySupplierIdLimit($suppliersProducts);
        $total_result = checkReadBySupplierId($suppliersProducts);
