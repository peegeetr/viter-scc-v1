...
class CapitalShare
{
    ...
    public $capital_share_amount;
    public $capital_share_balance;
    ...
    public function create()
    {
        try {
            ...
            $sql .= "capital_share_amount, ";
            $sql .= "capital_share_balance, ";
            ...
            $query->execute([
                ...
                "capital_share_amount" => $this->capital_share_amount,
                "capital_share_balance" => $this->capital_share_balance,
    ...
    public function search()
    {
        try {
            ...
            $sql .= "and capital_share_amount like :capital_share_amount ";
            ...
            $query->execute([
                ...
                "capital_share_amount" => "{$this->capital_search}%",
            ]);
        } catch (PDOException $ex) {
            $query = false;
        }
    ...
    public function update()
    {
        try {
            ...
            $sql .= "capital_share_balance = :capital_share_balance, ";
            $sql .= "capital_share_amount = :capital_share_amount, ";
            $sql .= "capital_share_total = :capital_share_total, ";
