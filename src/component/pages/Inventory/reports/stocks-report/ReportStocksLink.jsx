...
const ReportStocksLink = () => {
  ...
  return (
    <div
      ...
      onClick={handleShow}
    >
      <Link to={`${urlLink}/inventory/reports/stocks`} className="w-full py-2">
        ...
        <p className="ml-[35px] my-0">Stocks reports.</p>
      </Link>

      <Link
        to={`${urlLink}/inventory/reports/stocks`}
...
export default ReportStocksLink;
