...
const ReportSalesInvoicesList = ({ setItemEdit }) => {
  ...
  const {
    ...
    queryKey: ["blotter-sales-invoices", isSubmit],
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `/v1/report-sales-invoices/filter-date`, // search endpoint
        `/v1/report-sales-invoices/page/${pageParam}`, // list endpoint
  ...
  return (
    <>
      ...
      <div className="hidden print:grid justify-center grid-cols-[10rem_15rem] items-center capitalize py-8 mt-20">
...
export default ReportSalesInvoicesList;
