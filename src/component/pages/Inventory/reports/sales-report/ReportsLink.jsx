...
const ReportSalesLink = () => {
  ...
  return (
    <div
      ...
      onClick={handleShow}
    >
      <Link to={`${urlLink}/inventory/reports/sales`} className="w-full py-2">
        ...
        <p className="ml-[35px] my-0">Sales reports.</p>
      </Link>

      <Link
        to={`${urlLink}/inventory/reports/sales`}
...
export default ReportSalesLink;
